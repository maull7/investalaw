                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td style="padding:36px 40px;">
                                        <p style="margin:0 0 6px; font-size:11px; font-weight:700; letter-spacing:2.5px; text-transform:uppercase; color:#c99a3e;">Reset Password</p>
                                        ...
                                        <p style="margin:0 0 24px; font-size:15px; line-height:1.6; color:#667085;">
                                            Anda menerima email ini karena kami menerima permintaan reset password untuk akun Anda. Klik tombol di bawah ini untuk membuat password baru:
                                        </p>

                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
                                            <tr>
                                                <td align="center">
                                                    <a href="{{ $url }}" style="display:inline-block; padding:14px 32px; border-radius:12px; background:linear-gradient(135deg,#c99a3e,#e6c06a); color:#ffffff; font-size:15px; font-weight:800; text-decoration:none; box-shadow:0 8px 20px rgba(201,154,62,.35);">Reset Password</a>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <p style="margin:0 0 24px; font-size:13px; line-height:1.6; color:#667085;">
                                            Link reset berlaku selama 60 menit. Jika Anda tidak meminta reset password, abaikan email ini.
                                        </p>

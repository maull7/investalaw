                ...
                <form method="POST" action="{{ route('ai-prompts.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="type" id="type" required class="select-premium">
                            ...
                            <option value="rekomendasi" {{ old('type') === 'rekomendasi' ? 'selected' : '' }}>Rekomendasi</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" class="input-premium" placeholder="Contoh: Prompt Analisa Dokumen">
                    ...
                    <div>
                        ...
                        <textarea name="prompt_text" id="prompt_text" rows="10" required class="input-premium" placeholder="Masukkan prompt untuk AI...">{{ old('prompt_text') }}</textarea>
                        @error('prompt_text')<p class="mt-1.5 text-xs font-medium text-rose-600">{{ $message }}</p>@enderror
                    </div>

                    <div class="flex items-center gap-3">
                        <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="w-4 h-4 rounded border-[#d0d5dd] text-[#c99a3e] focus:ring-[#c99a3e]">

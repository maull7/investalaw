        ...
        <div class="relative hidden lg:flex flex-col justify-between p-12 bg-navy-gradient text-white overflow-hidden">
            ...
            <div class="relative max-w-md">
                ...
                <h2 class="mt-4 text-4xl xl:text-5xl font-bold leading-[1.1] tracking-tight">
                    Keep your workspace <span class="text-gold-gradient">secure</span>.
                </h2>
                <p class="mt-5 text-base text-white/70 leading-relaxed">
                    Reset your password anytime to keep your compliance documents and reviews protected.
                </p>
            </div>
        ...
        <div class="flex items-center justify-center px-6 sm:px-10 py-12 bg-white relative">
            ...
            <div class="w-full max-w-md">
                <div class="text-center lg:text-left">
                    ...
                    <h1 class="mt-5 text-3xl sm:text-4xl font-bold tracking-tight text-[#071833]">Lupa Password?</h1>
                    <p class="mt-2 text-sm text-[#667085]">Masukkan email Anda dan kami akan mengirimkan link untuk mereset password.</p>
                </div>

                @if (session('status'))
                    <div class="mt-6 flex items-center gap-3 p-4 rounded-2xl border border-emerald-200/60 bg-emerald-50/70 text-sm text-emerald-700">
                        {{ session('status') }}
                    </div>
                @endif
                ...
                <form method="POST" action="{{ route('password.email') }}" class="mt-8 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}" required autofocus autocomplete="username" class="input-premium" placeholder="you@firm.com">
                    </div>

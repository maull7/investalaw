            ...
            <nav class="mt-7 flex-1">
                @php
                    ...
                    $showMasterData =
                        ...
                        $canManagePrompts;
                    $pendingPaymentCount = $user->isAdmin()
                        ? \App\Models\UserPackage::where('status', 'pending')->count()
                        : 0;
                @endphp
                        ...
                        <li>
                            ...
                            <a href="{{ route('packages.payment.confirmations') }}"
                                ...
                                @if ($pendingPaymentCount > 0)
                                    <span
                                        class="ml-auto inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 rounded-full bg-[#c99a3e] text-[10px] font-bold text-[#071b3a]">
                                        {{ $pendingPaymentCount }}
                                    </span>
                                @endif
                            </a>

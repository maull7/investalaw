                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center justify-end gap-1.5">
                                    <a href="{{ route('partitions.index', $document) }}" class="inline-flex items-center justify-center w-9 h-9 rounded-xl text-[#c99a3e] hover:bg-[#c99a3e]/10 transition" title="Partisi Dokumen">
                                        <svg class="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.7"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12"/></svg>
                                    </a>

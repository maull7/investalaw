...
@section('content')
    <div x-data="pdfViewer('{{ route('regulations.file-raw', $regulation, false) }}', true)"
        ...
        <div class="flex items-center justify-between gap-3 px-4 sm:px-5 py-3 border-b border-[#e7eaf0] bg-white">
            <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                    <p class="text-sm font-bold text-[#071833] truncate">{{ $regulation->regulation_number }} — {{ $regulation->title }}</p>

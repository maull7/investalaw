            ...
            <x-card>
                ...
                <dl class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <dd class="mt-1.5 text-sm font-semibold text-[#071833]">{{ $category->created_at->format('d F Y') }}
                        </dd>
                    </div>
                </dl>
                @if ($category->description)
                ...
                <x-slot name="header">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="px-3 py-1 rounded-full bg-[#f6f8fb] text-xs font-bold text-[#667085]">{{ $category->regulations->count() }}
                                regulasi</span>
                        </div>
                    </div>
                </x-slot>
            ...
            <x-card :padding="false">
                <x-slot name="header">
                    <div class="flex items-center justify-between">
                        ...
                        <span
                            class="px-3 py-1 rounded-full bg-[#f6f8fb] text-xs font-bold text-[#667085]">{{ $category->subCategories->count() }}
                            item</span>
                    </div>
                </x-slot>
